...
function postProcessor(coupon, i){
  if($('#specialOfferSpinner').css("display")=="none"){
    var msg = $('#specialOfferMessage').text();
    
    if(msg == "Please enter passeger details" || msg == "Please enter passenger details"){
      savings = 1;
    }
    else {
      msg = msg.split("Rs.");
...
if($('#removeOffer').css("display")!="none"){
  document.getElementById('removeOffer').click();
}
...
var parameters = "ext_id=" + ext_id + "&auth_val=" + ext_auth + "&pos=14";
