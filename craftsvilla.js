...
$s('#addtocartbtn').after('<a target="_blank" href=' + url + '><input type="button" id="addtocartbtn2" class="addcart" title="Compare via Compare Hatke"></a>');
...
var msgToSend = final2send[1] + "~*~*" + price + "&moreData=null&isapparel=1";
