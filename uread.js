...
var title = $('#ctl00_phBody_ProductDetail_lblTitle').text().trim();
origProd = title;
title = title.split(" ");
var title2 = title.join("-");
var urlToFollow = url + title2;
var imgURL = chrome.extension.getURL("uread.png");
...
var msgToSend = final2send[1] + "~*~*" + parseFloat($('#ctl00_phBody_ProductDetail_lblourPrice').text().split("R")[1]) ;
...
chrome.runtime.onMessage.addListener(
 function(request, sender) {
  ...
  var origPrice = parseFloat($('#ctl00_phBody_ProductDetail_lblourPrice').text().split("R")[1]);
