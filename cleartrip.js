...
var parameters = "ext_id=" + ext_id + "&auth_val=" + ext_auth + "&pos=13";
...
if(curURL.split('cleartrip.com/flights/').length>1){
  var imgURL = chrome.extension.getURL("apply-coupon.png");
  console.log("TEst passed");
  if($('.upSell').length>1){
  $('.upSell:eq(1)').after("<a id='couponClick' href='javascript:void();'><img style='margin-top:-96px;margin-left:450px;' src='" + imgURL + "'></a>");
  addToDOM();
